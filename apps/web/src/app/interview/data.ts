    ...
    answer: { sections: [
      {
        ...
        vi: "*Với tôi,* / bước đầu tiên là cung cấp cho model **context đúng và vừa đủ**.",
      },
      {
        id: 'reason',
      ...
      },
      {
        ...
        vi: "*Ví dụ,* / với các câu hỏi dựa trên kiến thức, / tôi dùng **retrieval tốt và evidence liên quan** / thay vì chỉ dựa vào kiến thức sẵn có của model.",
      },
      {
        id: 'result',
        en: "*After that,* / I use **structured output** / and **backend validation** / when the result is used by the system. / If the model suggests an action, / the backend still checks the **business rules** / and **permissions**.",
        vi: "*Sau đó,* / tôi dùng **structured output và backend validation** / khi kết quả được hệ thống sử dụng. / Nếu model đề xuất một action, / backend vẫn kiểm tra **business rules và permission**.",
      },
      {
        id: 'settings',
        ...
        vi: "*Tôi cũng điều chỉnh model setting tùy theo task.* / Với những task cần tính factual, / tôi thường ưu tiên **temperature thấp hơn** / để output ổn định hơn và ít random hơn.",
      },
      {
        id: 'close',
        en: "*At the same time,* / I use **eval cases** / for important scenarios. / If the model is not sure, / I prefer to **ask for clarification**, / **require confirmation**, / or use a **safe fallback** / instead of letting it guess.",
        vi: "*Đồng thời,* / tôi dùng **eval cases** cho các tình huống quan trọng. / Nếu model không chắc, / tôi ưu tiên **hỏi lại, yêu cầu confirmation hoặc dùng safe fallback** / thay vì để model đoán.",
      },
      {
        id: 'extra',
    ...
    answer: { sections: [
      {
        ...
        vi: "*Với tôi,* / tôi đánh giá một hệ thống RAG ở **ba mức**: / **retrieval, chất lượng câu trả lời và runtime**.",
      },
      {
        id: 'reason',
      ...
      },
      {
        ...
        vi: "*Ví dụ,* / trong Clincove, tôi làm với **hybrid retrieval** / sử dụng PostgreSQL search, **pgvector và RRF**. / Tôi kiểm tra **ranking và fallback behavior** / để đảm bảo hệ thống có thể tìm đúng thông tin.",
      },
      {
        id: 'result',
        en: "*For the final answer,* / I check whether it is **grounded in the real source**, / with correct **citations** / and **provenance**.",
        vi: "*Với câu trả lời cuối cùng,* / tôi kiểm tra xem nó có **dựa trên nguồn dữ liệu thật hay không**, / thông qua **citation và provenance** chính xác.",
      },
      {
        id: 'close',
        en: "*For runtime,* / I check **latency**, **failures**, / and **fallback behavior** / to make sure the system is stable.",
        vi: "*Về runtime,* / tôi kiểm tra **latency, failures và fallback behavior** / để đảm bảo hệ thống chạy ổn định.",
      },
      {
        id: 'extra',
