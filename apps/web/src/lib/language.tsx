...
export const learnerCopy = {
  en: {
    ...
    correctAnswer: 'Correct answer', next: 'Next question →', result: 'See result →', formatMemory: 'Exam memory', formatMemoryDescription: 'Recall the exam shape before you practise it.', speakingWriting: 'Speaking + Writing', recall: 'Active recall', reveal: 'Reveal answer', hide: 'Hide answer', progressBySection: 'Progress by section', verified: 'Verified structure', conservative: 'Current conservative view',
  },
  vi: {
    ...
    correctAnswer: 'Đáp án đúng', next: 'Câu tiếp theo →', result: 'Xem kết quả →', formatMemory: 'Ghi nhớ đề thi', formatMemoryDescription: 'Tự truy hồi cấu trúc đề trước khi luyện tập.', speakingWriting: 'Nói + Viết', recall: 'Nhớ chủ động', reveal: 'Xem đáp án', hide: 'Ẩn đáp án', progressBySection: 'Tiến độ theo phần', verified: 'Cấu trúc đã xác minh', conservative: 'Thông tin hiện tại thận trọng',
  },
} as const;
